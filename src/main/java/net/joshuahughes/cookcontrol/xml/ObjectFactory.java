 ...
 * generated in the net.joshuahughes.cookcontrol.xml package. 
...
public class ObjectFactory {
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: net.joshuahughes.cookcontrol.xml
     * 
     */
